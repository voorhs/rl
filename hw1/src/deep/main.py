...
def experiment(env_name, n_iter, n_sessions, percentile, network, n_batches_reuse=1, mean_reward_to_win=None, mp=True, t_max=int(1e4)):
    env, agent = get_env_and_agent(env_name, network)
